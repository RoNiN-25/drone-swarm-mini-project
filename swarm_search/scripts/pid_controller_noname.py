...
rospy.Subscriber('/drone2/ground_truth_to_tf/pose', PoseStamped, poseCallback)
image_sub = rospy.Subscriber('/drone2/front_cam/camera/image', Image, image_callback)
# Create a publisher for the velocities
vel_pub = rospy.Publisher('/drone2/cmd_vel', Twist, queue_size=10)
