...
rospy.Subscriber('/uav5/ground_truth_to_tf/pose',PoseStamped,uav1PoseCallback)
...
rospy.Subscriber('/uav1/ground_truth_to_tf/pose',PoseStamped,uav5PoseCallback)
rospy.Subscriber('/uav5/cmd_vel',Twist,uav1VelCallback)
...
pub5 = rospy.Publisher('/uav1/cmd_vel',Twist,queue_size=10)
