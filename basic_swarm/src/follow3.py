...
rospy.Subscriber('/uav3/ground_truth_to_tf/pose',PoseStamped,uav1PoseCallback)
rospy.Subscriber('/uav2/ground_truth_to_tf/pose',PoseStamped,uav2PoseCallback)
rospy.Subscriber('/uav1/ground_truth_to_tf/pose',PoseStamped,uav3PoseCallback)
...
rospy.Subscriber('/uav3/cmd_vel',Twist,uav1VelCallback)

pub2 = rospy.Publisher('/uav2/cmd_vel',Twist,queue_size=10)
pub3 = rospy.Publisher('/uav1/cmd_vel',Twist,queue_size=10)
